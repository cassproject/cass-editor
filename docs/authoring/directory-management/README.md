...
![Directory Management - Directory List](~@img/directory-list.png)
...
![Directory Management - Directories Icon](~@img/directory-icon.png)
...
![Directory Management - Directory Path](~@img/directory-breadcrumbs.png)
...
![Directory Management - Directory Path](~@img/directory-cass-link.png)
...
![Framework - Go To Directory](~@img/framework-go-to-directory.png)
...
![Directory Management - Directory Information](~@img/directory-information.png)
...
- **Details** (only available for directories and frameworks)
    ...
    ![Directory Management - Directory Information Details](~@img/directory-information-details.png)
- **Users** - Click on "manage users and privacy" and a window dialogue will allow you to view and control access to this item.
    ![Directory Management - Directory Information Users](~@img/directory-information-users.png)
...
![Directory Management - Directory Editable](~@img/directory-editable.png)
...
![Directory Management - Create New](~@img/directory-create-new.png)
...
![Directory Management - Add New](~@img/directory-add-new.png)
...
![Directory Management - Create Directory](~@img/directory-create.png)
...
![Directory Management - Create Resource](~@img/directory-create-resource.png)
...
![Directory Management - Copy Progress Bar](~@img/directory-copy-progress.png)
...
![Directory Management - Delete Directory](~@img/directory-delete.png)
