...
![Competency Configuration](~@img/competency-configuration.png)
...
![Add Custom Competency Property](~@img/add-custom-property.png)

Once clicked, the ***New Competency Property*** dialogue window is displayed.

![New Competency Property](~@img/new-competency-property.png)
...
![Limit Values](~@img/limit-values-competency.png)
...
![Limit Values Enabled](~@img/limit-values-enabled-competency.png)
...
![Limit Concepts](~@img/limit-concepts.png)
...
![Limit By Type](~@img/limit-by-type.png)
...
![Competency Limited By Type](~@img/competency-limited-by-type.png)
...
Custom properties can be edited and deleted by selecting the appropriate action buttons to the right of the corresponding property entry in the ***Competency Properties*** list.
 ...
 ![Delete Custom Properties](~@img/competency-properties.png)
...
![Restrict Competency Types](~@img/restrict-competency-types.png)
...
![Permitted Values Table](~@img/permitted-values.png)
...
![Allow Levels](~@img/allow-levels.png)
...
![Restrict Competency Levels](~@img/restrict-levels.png)
...
![Enforced Levels](~@img/enforced-levels.png)
...
![Add New Level Modal](~@img/add-new-level.png)
...
Upon selecting the desired enforced levels, click the ***apply selected*** button at the bottom right of the ***select enforced levels*** dialog window to apply the enforced levels to competencies.
 ...
 ![Select Enforced Levels](~@img/apply-selected.png)
...
![Competnecy Relationship Configuration](~@img/competency-relationships-configuration.png)
...
![Relationship Display Options](~@img/display-options.png)
...
![Relationship Types Management](~@img/relationship-types.png)
...
![Relationship Types Enabled Toggle](~@img/relationship-types-enabled.png)
...
![Manage Relationships](~@img/manage-relationships.png)
...
![Manage Relationship Types](~@img/relationship-types.png)
...
![Resource Alignemnt Configuration](~@img/resource-alignment-configuration.png)
