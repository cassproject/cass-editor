...
export default {
    ...
    computed: {
        ...
        ...mapState(useEditorStore, ['queryParams', 'addAnother', 'framework']),
        canPaste: function() {
        ...
        recomputeHierarchy: function() {
            const editorStore = useEditorStore();
            return editorStore.recomputeHierarchy;
        }
    },
    watch: {
        selectAll(val) {
    ...
    methods: {
        ...
        add: async function(containerId, previousSibling) {
            ...
            c["skos:prefLabel"] = {"@language": useEditorStore().defaultLanguage, "@value": "New Progression Level"};
