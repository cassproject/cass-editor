...
To add content to this modal, import the relevant component and trigger it
via the app store's showModal action. The payload should at minimum
return an object with component: 'View' so the dynamic :is=dynamicModal
returns content.
...
export default {
    ...
    computed: {
        ...mapState(useAppStore, {
            showModal: 'showModalGetter',
            dynamicModalContentFromStore: 'dynamicModalContent'
        }),
        dynamicModalContent: function() {
            if (this.showModal) {
                return this.dynamicModalContentFromStore;
            } else {
                return {};
            }
        },
