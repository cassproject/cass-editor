...
test.describe('Common Mixin Coverage', () => {
  test('Exercise common mixin utility methods via Framework page', async ({
    page
  }) => {
  ...
  test('Exercise common mixin computed properties', async ({
    page
  }) => {
    await page.goto('/#/frameworks?server=http://localhost/api/');
    await page.waitForLoadState('domcontentloaded');
  ...
  test('Exercise common mixin getCTID with various inputs', async ({
    page
  }) => {
    await page.goto('/#/frameworks?server=http://localhost/api/');
    await page.waitForLoadState('domcontentloaded');
