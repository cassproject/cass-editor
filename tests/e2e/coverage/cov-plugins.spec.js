...
test.describe('Plugins Coverage', () => {
  test('Plugin Manager page loads', async ({
    page
  }) => {
  ...
  test('PluginManager data and computed properties', async ({
    page
  }) => {
    await page.goto('/#/pluginManager?server=http://localhost/api/');
    await page.waitForLoadState('domcontentloaded');
  ...
  test('Add new plugin button navigates to detail view', async ({
    page
  }) => {
    await page.goto('/#/pluginManager?server=http://localhost/api/');
    await page.waitForLoadState('domcontentloaded');
  ...
  test('Exercise pluginUtil mixin methods', async ({
    page
  }) => {
    await page.goto('/#/pluginManager?server=http://localhost/api/');
    await page.waitForLoadState('domcontentloaded');
