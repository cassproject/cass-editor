...
test.describe('Organization Views Coverage', () => {
  test('Organizations list page loads', async ({
    page
  }) => {
  ...
  test('Organizations Vue data and computed properties', async ({
    page
  }) => {
    await page.goto('/#/organizations?server=http://localhost/api/');
    await page.waitForLoadState('domcontentloaded');
  ...
  test('Toggle sort options on organizations page', async ({
    page
  }) => {
    await page.goto('/#/organizations?server=http://localhost/api/');
    await page.waitForLoadState('domcontentloaded');
  ...
  test('Organizations page exercises common mixin', async ({
    page
  }) => {
    await page.goto('/#/organizations?server=http://localhost/api/');
    await page.waitForLoadState('domcontentloaded');
