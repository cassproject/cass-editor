...
test.describe('Welcome page deep coverage', () => {
  let uid;
  test('Welcome page structure and all sections', async ({
    page
  }) => {
  ...
  test('Welcome page computed properties and data', async ({
    page
  }) => {
    await page.goto('/#/?server=http://localhost/api/');
    await page.waitForLoadState('domcontentloaded');
  ...
  test('Welcome page navigation links work', async ({
    page
  }) => {
    await page.goto('/#/?server=http://localhost/api/');
    await page.waitForLoadState('domcontentloaded');
  ...
  test('Welcome page after login shows user state', async ({
    page
  }) => {
