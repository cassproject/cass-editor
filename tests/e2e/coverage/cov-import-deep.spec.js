...
test('Import deep: URL, server, and text import tabs with input', async ({
  page
}) => {
  let uid;
  ...
  const tabIds = ['#import-file-tab-button', '#import-server-tab-button', '#import-text-tab-button', '#import-url-tab-button'];
