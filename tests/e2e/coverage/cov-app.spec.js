...
test('App: basic rendering and #app visible', async ({
  page
}) => {
...
test('App: computed properties accessible', async ({
  page
}) => {
...
test('App: editorClass and showSideNav values', async ({
  page
}) => {
  await page.goto('/#/frameworks?server=http://localhost/api/');
  await page.waitForLoadState('domcontentloaded');
...
test('App: inIframe detection via store', async ({
  page
}) => {
  await page.goto('/#/?server=http://localhost/api/');
  await page.waitForLoadState('domcontentloaded');
...
test('App: route changes update currentRoute', async ({
  page
}) => {
  await page.goto('/#/frameworks?server=http://localhost/api/');
  await page.waitForLoadState('domcontentloaded');
...
test('App: banner and motd store mutations', async ({
  page
}) => {
  await page.goto('/#/frameworks?server=http://localhost/api/');
  await page.waitForLoadState('domcontentloaded');
