(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["chunk-4d33ae12"],{
...
var render = function render() {
  ...
  return _vm.expandedThing ? _c('div', {
    ...
    return _c('div', {
    ...
    }) : _vm._e()]) : _vm._e()] : _vm._e(), _vm.isVersionIdentifier(item) ? _c('div', {
      attrs: {
        "temp": _vm.realItem = _vm.getVersionIdentifier(item)
      }
    }, [_vm.editingProperty && _vm.realItem ? _c('div', {
      staticClass: "columns"
    }, [_c('div', {
      staticClass: "column"
    }, [_c('div', {
      ...
      staticClass: "control"
    }, [_c('div', [_vm._v(" Identifier Value Code: " + _vm._s(_vm.getDisplayString(_vm.realItem['https://purl.org/ctdl/terms/identifierValueCode'])) + " ")]), _c('div', [_vm._v(" Identifier Type Name: " + _vm._s(_vm.getDisplayString(_vm.realItem['https://purl.org/ctdl/terms/identifierTypeName'])) + " ")]), _c('div', [_vm._v(" Identifier Type: " + _vm._s(_vm.getDisplayString(_vm.realItem['https://purl.org/ctdl/terms/identifierType'])) + " ")])])])]), _c('div', {
    ...
    })])])])])]) : _vm.realItem ? _c('div', [_c('div', {
      staticClass: "expanded-view-property"
    }, [_c('div', {
      staticClass: "property",
      attrs: {
        "title": _vm.getDisplayString(_vm.realItem['https://purl.org/ctdl/terms/identifierTypeName'])
      }
    }, [_c('span', {
      staticClass: "tag is-size-7 is-light"
    }, [_vm._v("Version Identifier")]), _vm._v(" " + _vm._s(_vm.getDisplayString(_vm.realItem['https://purl.org/ctdl/terms/identifierTypeName'])) + " ")])])]) : _vm._e()]) : !_vm.editingProperty && _vm.isLink(item) && _vm.expandedProperty != '@id' && _vm.expandedProperty != 'registryURL' ? [_c(_vm.dynamicThing, {
      tag: "Component",
      ...
      staticClass: "tag is-size-7 is-light language",
      on: {
        "click": function click($event) {
  ...
  }, [_vm._m(4), _c('span', [_vm._v(" Add " + _vm._s(_vm.displayLabel) + " ")])]) : _vm.addOrSearch !== 'search' ? _vm._l(_vm.range, function (targetType) {
    return _c('button', {
      key: targetType,
    ...
    }, [_vm._m(5, true), _c('span', [_vm._v(" Add " + _vm._s(_vm.displayLabel) + " ")])]);
...
// CONCATENATED MODULE: ./src/lode/components/Property.vue?vue&type=template&id=10993df8
...
/* harmony default export */ var Propertyvue_type_script_lang_js = ({
  ...
  components: {
    ...
    ThingEditing: function ThingEditing() {
      return Promise.all(/* import() */[__webpack_require__.e("chunk-6a6fd63e"), __webpack_require__.e("chunk-2d0d5fe2"), __webpack_require__.e("chunk-576b8942"), __webpack_require__.e("chunk-35fc61ec"), __webpack_require__.e("chunk-6b291276")]).then(__webpack_require__.bind(null, "8051"));
    },
    ...
    PropertyString: function PropertyString() {
      return __webpack_require__.e(/* import() */ "chunk-00301708").then(__webpack_require__.bind(null, "d17f"));
    },
  ...
  methods: {
    getDisplayString: function getDisplayString(thing) {
      return EcRemoteLinkedData.getDisplayStringFrom(thing);
    },
    getVersionIdentifier: function getVersionIdentifier(item) {
    ...
    add: function () {
      var _add = Object(asyncToGenerator["a" /* default */])(/*#__PURE__*/Object(regenerator["a" /* default */])().m(function _callee3(type) {
    ...
    removeByValue: function () {
      var _removeByValue = Object(asyncToGenerator["a" /* default */])(/*#__PURE__*/Object(regenerator["a" /* default */])().m(function _callee4(value) {
    ...
    remove: function () {
      var _remove = Object(asyncToGenerator["a" /* default */])(/*#__PURE__*/Object(regenerator["a" /* default */])().m(function _callee5(index) {
        var f, value;
    ...
    isVersionIdentifier: function isVersionIdentifier(type) {
    ...
    getExpandedValue: function () {
      var _getExpandedValue = Object(asyncToGenerator["a" /* default */])(/*#__PURE__*/Object(regenerator["a" /* default */])().m(function _callee6() {
  ...
  watch: {
    ...
    expandedThing: function expandedThing(newval, oldval) {
...
// EXTERNAL MODULE: ./src/lode/components/Property.vue?vue&type=style&index=0&id=10993df8&prod&lang=scss
var Propertyvue_type_style_index_0_id_10993df8_prod_lang_scss = __webpack_require__("6ce6");
...
"use strict";
/* harmony import */ var _node_modules_mini_css_extract_plugin_dist_loader_js_ref_9_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_9_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_9_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_9_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_1_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Property_vue_vue_type_style_index_0_id_10993df8_prod_lang_scss__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("8e2c");
/* harmony import */ var _node_modules_mini_css_extract_plugin_dist_loader_js_ref_9_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_9_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_9_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_9_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_1_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Property_vue_vue_type_style_index_0_id_10993df8_prod_lang_scss__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_mini_css_extract_plugin_dist_loader_js_ref_9_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_9_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_9_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_9_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_1_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Property_vue_vue_type_style_index_0_id_10993df8_prod_lang_scss__WEBPACK_IMPORTED_MODULE_0__);
...
//# sourceMappingURL=chunk-4d33ae12.73847cf8.js.map