...
// CONCATENATED MODULE: ./src/lode/components/Thing.vue?vue&type=template&id=62c2f5bc
...
/* harmony default export */ var Thingvue_type_script_lang_js = ({
  ...
  components: {
    Property: function Property() {
      return Promise.all(/* import() */[__webpack_require__.e("chunk-4d33ae12"), __webpack_require__.e("chunk-25a2af2a")]).then(__webpack_require__.bind(null, "5e26"));
    },
  ...
  methods: {
    ...
    expand: function () {
      var _expand = Object(asyncToGenerator["a" /* default */])(/*#__PURE__*/Object(regenerator["a" /* default */])().m(function _callee(o, after) {
        var me, toExpand, expanded, _t;
    ...
    loadSchema: function loadSchema(after, type) {
      ...
      if (this.$store.state.lode.schemata[type] === undefined && type.indexOf("EncryptedValue") === -1) {
        ...
        EcRemote.getExpectingObject("", augmentedType, /*#__PURE__*/function () {
          var _ref = Object(asyncToGenerator["a" /* default */])(/*#__PURE__*/Object(regenerator["a" /* default */])().m(function _callee2(context) {
            var expanded, _t2;
    ...
    add: function add(property, value) {
      ...
      new EcAsyncHelper().each(me.getAllTypes(value), function (type, callback) {
        me.loadSchema(callback, type);
      }, /*#__PURE__*/Object(asyncToGenerator["a" /* default */])(/*#__PURE__*/Object(regenerator["a" /* default */])().m(function _callee3() {
        var expanded, _t3;
    ...
    save: function () {
      var _save = Object(asyncToGenerator["a" /* default */])(/*#__PURE__*/Object(regenerator["a" /* default */])().m(function _callee4() {
        var saver, me, compacted, rld, _t4;
        return Object(regenerator["a" /* default */])().w(function (_context4) {
          while (1) switch (_context4.p = _context4.n) {
            ...
            case 1:
              ...
              return _context4.a(2, "Could not save.");
            case 2:
              _context4.n = 1;
              break;
            case 3:
  ...
  watch: {
    ...
    changedObject: function () {
      var _changedObject = Object(asyncToGenerator["a" /* default */])(/*#__PURE__*/Object(regenerator["a" /* default */])().m(function _callee5() {
        var type, encryptedType, encryptedThing, returnObject, thing, _t5;
...
//# sourceMappingURL=chunk-2d0a4fe9.8f475717.js.map