...
/* harmony default export */ var UserGroupEditorvue_type_script_lang_js = ({
  ...
  methods: {
    ...
    pushRemovedMembersToSubGroupsForSave: function pushRemovedMembersToSubGroupsForSave() {
      ...
      var _iterator0 = Object(createForOfIteratorHelper["a" /* default */])(this.membersToRemove),
        _step0;
      try {
        for (_iterator0.s(); !(_step0 = _iterator0.n()).done;) {
          var mtrId = _step0.value;
          var memberToRemove = this.allPersonMap[mtrId];
          if (memberToRemove) {
            var memberPk = this.getPersonEcPk(memberToRemove);
            if (memberPk) {
              var subGroupIds = this.getSubGroupIdsForUserGroup(this.currentUserGroupId);
              var _iterator1 = Object(createForOfIteratorHelper["a" /* default */])(subGroupIds),
                _step1;
              try {
                for (_iterator1.s(); !(_step1 = _iterator1.n()).done;) {
                  var sgId = _step1.value;
    ...
    appendGroupSubGroupIdsToArray: function appendGroupSubGroupIdsToArray(groupId, subGroupArray) {
      ...
      if (ugdo && ugdo.subGroups && ugdo.subGroups.length > 0) {
        var _iterator10 = Object(createForOfIteratorHelper["a" /* default */])(ugdo.subGroups),
          _step10;
        try {
          for (_iterator10.s(); !(_step10 = _iterator10.n()).done;) {
            var sg = _step10.value;
    ...
    setCurrentUserGroupManagerAndUserListsForDetailView: function setCurrentUserGroupManagerAndUserListsForDetailView() {
      ...
      var _iterator11 = Object(createForOfIteratorHelper["a" /* default */])(this.currentUserGroup.employee),
        _step11;
      try {
        for (_iterator11.s(); !(_step11 = _iterator11.n()).done;) {
          var empId = _step11.value;
    ...
    buildUserGroupMap: function buildUserGroupMap(userGroupList) {
      this.userGroupMap = {};
      var _iterator12 = Object(createForOfIteratorHelper["a" /* default */])(userGroupList),
        _step12;
      try {
        for (_iterator12.s(); !(_step12 = _iterator12.n()).done;) {
          var ug = _step12.value;
    ...
    buildUserGroupDisplayObjects: function buildUserGroupDisplayObjects(userGroupList) {
      ...
      var _iterator13 = Object(createForOfIteratorHelper["a" /* default */])(userGroupList),
        _step13;
      try {
        for (_iterator13.s(); !(_step13 = _iterator13.n()).done;) {
          var ug = _step13.value;
          var ugdo = {};
          ugdo.id = ug.shortId();
    ...
    assignUserGroupDisplayObjectsSubGroups: function assignUserGroupDisplayObjectsSubGroups(ugDisplayObjs) {
      var _iterator14 = Object(createForOfIteratorHelper["a" /* default */])(ugDisplayObjs.doList),
        _step14;
      try {
        for (_iterator14.s(); !(_step14 = _iterator14.n()).done;) {
          var ugdo = _step14.value;
          if (ugdo.memberOf) {
    ...
    addRootUserGroupsToUserGroupDisplayList: function addRootUserGroupsToUserGroupDisplayList(ugDisplayObjs) {
      var _iterator15 = Object(createForOfIteratorHelper["a" /* default */])(ugDisplayObjs.doList),
        _step15;
      try {
        for (_iterator15.s(); !(_step15 = _iterator15.n()).done;) {
          var ugdo = _step15.value;
          if (!ugdo.memberOf) {
    ...
    buildInitialGroupMembersDisplayData: function buildInitialGroupMembersDisplayData() {
      ...
      var _iterator16 = Object(createForOfIteratorHelper["a" /* default */])(this.allPersonList),
        _step16;
      try {
    ...
    addMembershipData: function addMembershipData(gmMap, pdoKey, pkData, ug) {
      if (pkData) {
        var _iterator17 = Object(createForOfIteratorHelper["a" /* default */])(pkData),
          _step17;
        try {
          for (_iterator17.s(); !(_step17 = _iterator17.n()).done;) {
            var pk = _step17.value;
    ...
    filterOutNonMembers: function filterOutNonMembers(initGrpMemDispData) {
      var _iterator18 = Object(createForOfIteratorHelper["a" /* default */])(initGrpMemDispData.gmList),
        _step18;
      try {
        for (_iterator18.s(); !(_step18 = _iterator18.n()).done;) {
          var gm = _step18.value;
    ...
    sortGroupMemberListMembershipData: function sortGroupMemberListMembershipData() {
      var _iterator19 = Object(createForOfIteratorHelper["a" /* default */])(this.allGroupMembersList),
        _step19;
      try {
        for (_iterator19.s(); !(_step19 = _iterator19.n()).done;) {
          var gm = _step19.value;
    ...
    buildAllPersonMap: function buildAllPersonMap() {
      this.allPersonMap = {};
      var _iterator20 = Object(createForOfIteratorHelper["a" /* default */])(this.allPersonList),
        _step20;
      try {
...
//# sourceMappingURL=userGroupEditor.35594970.js.map